...
import { ArrowLeft, FileText, Film, ImageIcon, MapPin, Sparkles, Users } from "lucide-react";
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 border-t border-ink-100 pt-4 sm:grid-cols-4">
          ...
          <div>
            ...
            <p className="flex items-center gap-1 text-sm font-medium text-ink-800">
              <MapPin className="h-3.5 w-3.5 text-ink-400" /> {complaint.location.villageOrTown}
            </p>
          </div>
          <div>
